...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/pi/openmpi/build/opal/mca/event/libevent2022/libevent/include -I/home/pi/openmpi/code/openmpi-4.1.1/opal/mca/event/libevent2022/libevent -I/home/pi/openmpi/code/openmpi-4.1.1/opal/mca/event/libevent2022/libevent/include -I/home/pi/openmpi/build/opal/mca/hwloc/hwloc201/hwloc/include -I/home/pi/openmpi/code/openmpi-4.1.1/opal/mca/hwloc/hwloc201/hwloc/include   -I/usr/local/include -I/usr/local/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/home/pi/openmpi/install --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_FORTRAN_F08_HANDLE_ALIGNMENT 8
...
#define OMPI_MCA_OP_HAVE_SSE3 0

/* SSE4.1 supported in the current build */
#define OMPI_MCA_OP_HAVE_SSE41 0
...
#define OMPI_TARBALL_VERSION "4.1.1"
...
#define OPAL_ASSEMBLY_ARCH OPAL_ARM64

/* Whether to use builtin atomics */
#define OPAL_ASSEMBLY_BUILTIN OPAL_BUILTIN_NO

/* Format of assembly file */
#define OPAL_ASSEMBLY_FORMAT "default-.text-.globl-:--.L-@-1-1-1-1-1"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 655873

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 10.2.1
...
#define OPAL_IDENT_STRING "4.1.1"
...
#define OPAL_PACKAGE_STRING "Open MPI root@pi-1-1 Distribution"
...
#define OPAL_RELEASE_DATE "Apr 24, 2021"
...
#define OPAL_TARBALL_VERSION "4.1.1"
...
#define ORTE_RELEASE_DATE "Apr 24, 2021"
...
#define OSHMEM_TARBALL_VERSION "4.1.1"
...
#define PACKAGE_STRING "Open MPI 4.1.1"
